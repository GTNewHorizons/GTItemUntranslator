...
public class TravelEntitySpecialRenderer extends TileEntitySpecialRenderer {
    ...
    // Удалено поле travelAnchorBFR и метод ensureTravelAnchorBFR
            ...
            }
            {
                ...
                GL11.glTranslatef((float) x + 0.5f, (float) y + 0.5f, (float) z + 0.5f);
                {
                    ...
                    // === TravelAnchorFix: отрисовка текста через ванильный FontRenderer ===
                    {
                        ...
                        if (fr != null) { // Дополнительная проверка на null
                            GL11.glPushMatrix();
                            try {
                                ...
                                GL11.glTranslatef(0.0F, 0.0F, -0.03F); // Возвращаемся
                                // Основной текст
                                fr.drawString(toRender, baseX, 0, 0xFFFFFFFF); // основной
